...
namespace QuizApp
{
    public class Quizhelper
    {
        ...
        public string GetTopicDescription(string topic)
        {
            ...
            {
                topicDescription = "Engineering is the application of science and mathematics by which the properties of matter and the sources of energy in nature are made useful to people";
            } 
            else if (topic == "Business")
            {
                topicDescription = "Business is defined as an organization or enterprising entity engaged in commercial, industrial, or professional activities. Businesses can be for-profit entities or non-profit organizations";
            }
            else if (topic == "Programming")
            {
                topicDescription = "Programming is the process of instructing or learning by means of an instructional program. b : the process of preparing an instructional program for a device ";
            }
